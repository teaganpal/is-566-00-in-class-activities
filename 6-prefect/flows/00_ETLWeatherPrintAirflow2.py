...
from weather_utils import extract_weather_data, log_weather_data, transform_weather_data
...
@task
def load_task(weather_data: list[dict[str, Any]]) -> None:
    log_weather_data(weather_data)


@flow(name="ETLWeatherPrintAirflow2")
def etl_weather_print_airflow2(location: str = "Berlin") -> None:
